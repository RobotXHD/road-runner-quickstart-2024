...
@Autonomous
@Disabled
public class atunonom_adevraat_rosu_dreapta extends LinearOpMode {
    ...
    public Thread Atunonom = new Thread(new Runnable(){
        ...
        public void run() {
            if(varrez=="Dreapta") {
                ...
                Rotire(-210,0.5);
                Translatare(85,0,0.5);
                lastTime = System.currentTimeMillis();
                while (lastTime + 200 > System.currentTimeMillis()) {
                }
                Translatare(0,180,0.4);
                lastTime = System.currentTimeMillis();
                while (lastTime + 200 > System.currentTimeMillis()) {
                }
                lastTime = System.currentTimeMillis();
                while (lastTime + 4000 > System.currentTimeMillis()) {
                }
