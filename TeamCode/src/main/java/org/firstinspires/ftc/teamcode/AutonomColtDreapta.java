...
@Autonomous
public class AutonomColtDreapta extends LinearOpMode {
    ...
    public Thread Autonom = new Thread(new Runnable(){
        @Override
        public void run() {
            loader2.setPosition(0.7);
            loader13.setPosition(0.7);
            kdf(200);

            if(varrez=="Dreapta" && !isStopRequested()) {
               Translatare(-186,0,0.4);
               Rotire(78,0.4);
               kdf(100);
               ...
               while(sfoara.getCurrentPosition() > 2099){
                    sfoara.setPower(-1);
                }
            ...
            if(varrez == "Mijloc" && !isStopRequested()) {
                ...
                Translatare(-16,0,0.2);

                kdf(200);


                while(sfoara.getCurrentPosition() < 2381){
                    sfoara.setPower(1);
                }
                ...
                kdf(200);
                loader2.setPosition(0.65);
                loader13.setPosition(0.25);
                ...
                Rotire(-110,0.4);
                Translatare(18,0,0.4);

                kdf(300);

                Translatare(120,0,0.4);

                kdf(400);

                while(sfoara.getCurrentPosition() > 2000){
                    sfoara.setPower(-1);
                }
                ...
                while(sfoara.getCurrentPosition() < 2380){
                    sfoara.setPower(1);
                }
