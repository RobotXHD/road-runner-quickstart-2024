...
public class Domnule extends OpMode {
    ...
    public void init() {
        ...
        pula = hardwareMap.get(Servo.class, "pula");
...
//        motorBL.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
    ...
    @Override
    public void loop() {
            telemetry.addData("poz servo", pula.getPosition());
