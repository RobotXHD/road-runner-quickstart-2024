...
@Autonomous
public class autonom_pid_pe_masa_albastru extends LinearOpMode {
...
////                kdf(200);
                ...
                while (ungur.blue() < 120 || lastTime + 4000 > System.currentTimeMillis() ){//|| ((DistanceSensor) ungur).getDistance(DistanceUnit.MM) < 10 ) {
...
////                kdf(200);
                ...
                while (ungur.blue() < 120 || lastTime + 3000 > System.currentTimeMillis()){//|| ((DistanceSensor) ungur).getDistance(DistanceUnit.MM) < 10 ) {
                    Translatare(0, 11, 0.9);
                }
