...
@Autonomous
public class Autonom_pid_pe_tacsu_rosu extends LinearOpMode {
...
////                kdf(200);
                ...
                while (ungur.red() < 120 || lastTime + 4000 > System.currentTimeMillis()) {
...
////                kdf(200);
                filament(100);
                lastTime = System.currentTimeMillis();
                while (ungur.red() < 120 || lastTime + 3000 > System.currentTimeMillis()) {
                    Translatare(0, 11, 0.9);
                }
