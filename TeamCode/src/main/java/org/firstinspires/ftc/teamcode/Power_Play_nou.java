...
@TeleOp
public class Power_Play_nou extends OpMode {
...
//                    arm.setPower(Config.armcoefficient * gamepad2.right_stick_y);
...
//                }
                ...
                if (gamepad2.dpad_up) {
                    balanganitor.setPosition(0.45);
                }

                if (gamepad2.dpad_down) {
                    balanganitor.setPosition(0.15);
                }
                ...
                if(gamepad2.dpad_left){
                    slider1.setTargetPosition(1500);
                    slider2.setTargetPosition(1400);
                    slider2.setMode(DcMotorEx.RunMode.RUN_TO_POSITION);
                    slider1.setMode(DcMotorEx.RunMode.RUN_TO_POSITION);
                    slider1.setPower(0.8);
        ...
        public void Burdu(int poz){
            ...
            //arm.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(Config.p, Config.i, Config.d, 0));
            arm.setTargetPosition(poz);
            arm.setMode(DcMotorEx.RunMode.RUN_TO_POSITION);
            arm.setPower(0.6);
            while(arm.isBusy()){}
            arm.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
            pid.setSetpoint(arm.getCurrentPosition());
            Object lastTime = java.lang.System.currentTimeMillis();
            while(arm.getCurrentPosition() <= poz){
                pidResult = pid.performPID(arm.getCurrentPosition());
                arm.setPower(pidResult);
            }
            pidResult = pid.performPID(arm.getCurrentPosition());
            ...
            while(!stop){
                ...
                if(gamepad2.right_stick_y != 0.0){
                    if (gamepad2.left_bumper){
                        arm.setPower(0.45 * gamepad2.right_stick_y);
...
//        motorBR = hardwareMap.get(DcMotorEx.class, "motorBR"); // Motor Back-Left
        ...
        arm = (DcMotorEx) hardwareMap.dcMotor.get("arm1");
...
//        motorBL.setMode(DcMotorEx.RunMode.RUN_USING_ENCODER);
    ...
    public void loop() {
        ...
        telemetry.addData("Left Bumper", gamepad1.left_bumper);
        telemetry.addData("Brat pozitie1: ", arm.getCurrentPosition());
...
//        telemetry.addData("MOTORBR: ", motorBR.getCurrentPosition());
        ...
        telemetry.addData("MotorVelocity: ", arm.getVelocity());
