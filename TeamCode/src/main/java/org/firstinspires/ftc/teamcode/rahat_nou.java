...
@TeleOp
public class rahat_nou extends OpMode {
...
//                    if(ceva){
//                        ceva = false;
//                        pid.setSetpoint(sculantul.getCurrentPosition());
//                    }
...
//                if(gamepad2.x){
//                    sculantul.setTargetPosition(-162);
//                    arm2.setTargetPosition(-162);
//                    sculantul.setMode(DcMotorEx.RunMode.RUN_TO_POSITION);
//                    arm2.setMode(DcMotorEx.RunMode.RUN_TO_POSITION);
//                    sculantul.setPower(0.8);
//                    arm2.setPower(0.8);
//                    while(sculantul.isBusy() && arm2.isBusy()){}
//                    sculantul.setPower(0);
//                    arm2.setPower(0);
//                    sculantul.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
...
//                }
        ...
        public void Burdu(int poz, double pow){
            pid.enable();
            pid.setPID(Config.pstatic, Config.istatic, Config.dstatic);
            //sculantul.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(Config.p, Config.i, Config.d, 0));
            sculantul.setTargetPosition(poz);
            sculantul.setMode(DcMotorEx.RunMode.RUN_TO_POSITION);
            sculantul.setPower(pow);
            while(sculantul.isBusy()){}
            sculantul.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
            pid.setSetpoint(sculantul.getCurrentPosition());
