...
@Autonomous
public class autonom_pid_pe_tacsu_albastru extends LinearOpMode {
...
//                kdf(200);
                ...
                kdf(200);
                anaconda(410,410,0.4,400);
////                while (ungur.blue() < 300){
//////                //Translatare(0,7,1);
//////                //}
////                kdf(200);
                filament(100);
                lastTime = System.currentTimeMillis();
                while (ungur.blue() < 120 || lastTime + 4000 > System.currentTimeMillis()) {
...
////                kdf(200);
                Translatare(0,-90,0.6);
//                kdf(200);
                Rotire(114,0.3);
                kdf(200);
//                //Messi(-1360,0.7, arm1,0.95);
//                kdf(200);
                Translatare(0,-22,0.3);
//                kdf(200);
...
////                while (ungur.blue() < 120 || ((DistanceSensor) ungur).getDistance(DistanceUnit.MM) < 10 ) {
...
////                kdf(200);
                filament(100);
                lastTime = System.currentTimeMillis();
                while (ungur.blue() < 120 || lastTime + 3000 > System.currentTimeMillis()) {
                    Translatare(0, 11, 0.9);
                }
